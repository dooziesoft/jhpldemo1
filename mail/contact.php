...
// header("location: http://dooziesoft.in/enstructurawebsite/contact.html");

$_SESSION['msg']="Hello";
 header("Location: https://dooziesoft.github.io/jhpldemo1/contact.html");
 exit();
